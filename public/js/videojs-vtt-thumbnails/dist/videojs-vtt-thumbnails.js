...
var vttThumbnailsPlugin = function () {
  ...
  vttThumbnailsPlugin.prototype.initializeThumbnails = function initializeThumbnails() {
    ...
    //var url = new URL(this.options.src, baseUrl)
  ...
  vttThumbnailsPlugin.prototype.getBaseUrl = function getBaseUrl() {
    ...
    //return [window.location.protocol, '//', window.location.hostname, window.location.port ? ':' + window.location.port : '', window.location].join('').split(/([^\/]*)$/gi).shift();
