...
(function (global, factory) {
    ...
    var ConcreteButton = (function (_VideoJsButtonClass) {
        ...
        function ConcreteButton(player) {
            ...
            return possibleConstructorReturn(
                this,
                _VideoJsButtonClass.call(this, player, {
    ...
    var HlsQualitySelectorPlugin = (function () {
                ...
                var _loop = function _loop(i) {
                    if (
                        ...
                        var levelItem = _this.getQualityMenuItem.call(_this, {
                            ...
                            // label: levels[i].height >= 720 ? levels[i].height + 'p<sup>HD</sup>' : levels[i].height + 'p', // line A
        ...
        HlsQualitySelectorPlugin.prototype.setQuality = function setQuality(
            ...
            for (var i = 0; i < qualityList.length; ++i) {
                ...
                //   console.log("quality"+JSON.stringify(quality.height))
                quality.enabled =
                    quality.height === height || height === "auto";
            }
    ...
    var onPlayerReady = function onPlayerReady(player, options) {
        ...
        player.hlsQualitySelector = new HlsQualitySelectorPlugin(
            player,
            options
        );
    };
